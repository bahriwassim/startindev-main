          ...
          <div className="text-center fade-in">
            <div className="mb-8">
              <div className="w-32 h-32 mx-auto bg-white/15 backdrop-blur-sm rounded-3xl flex items-center justify-center mb-6 shadow-2xl border border-white/20">
                <img src={logo} alt="StartInDev" className="w-24 h-24 object-contain" />
              </div>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight text-white drop-shadow-lg" data-testid="hero-title">
              StartInDev Groupe
            </h1>
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto leading-relaxed text-white/95 drop-shadow-md" data-testid="hero-subtitle">
              Des solutions digitales sur mesure pour vos univers
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/ebusiness">
                <Button className="bg-white text-primary border-2 border-white rounded-2xl px-8 py-4 text-lg font-bold inline-flex items-center justify-center transition-all duration-300 hover:bg-accent hover:text-white hover:border-accent hover:shadow-2xl hover:-translate-y-1 hover:scale-105 mr-4" data-testid="hero-cta-ebusiness">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl card-hover fade-in stagger-1 border border-border/50" data-testid="card-ecommerce">
              ...
              <div className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-foreground">E-Business</h3>
                </div>
                <p className="text-muted-foreground mb-6 leading-relaxed" data-testid="ecommerce-description">
            ...
            <div className="bg-card/80 backdrop-blur-sm rounded-3xl overflow-hidden shadow-xl card-hover fade-in stagger-2 border border-border/50" data-testid="card-entertainment">
              ...
              <div className="p-8">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-2xl font-bold text-foreground">Entertainment</h3>
                </div>
                <p className="text-muted-foreground mb-6 leading-relaxed" data-testid="entertainment-description">
