...
export default function GroupeContact() {
  return (
    <div className="min-h-screen">
      <div className="fixed top-0 w-full bg-white/90 backdrop-blur-md border-b border-border/50 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-12 text-sm overflow-x-auto">
            ...
            <a href="/groupe#intro" className="px-3 py-2 text-muted-foreground hover:text-primary transition-colors">Intro</a>
            <a href="/groupe#poles" className="px-3 py-2 text-muted-foreground hover:text-primary transition-colors">Pôles</a>
            <a href="/groupe#trust" className="px-3 py-2 text-muted-foreground hover:text-primary transition-colors">Références</a>
      ...
      <section className="hero-gradient pt-28 pb-16 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Contact Groupe</h1>
          <p className="text-xl opacity-95 max-w-2xl">Parlons de votre projet digital.</p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 bg-card rounded-2xl p-8 shadow-lg border border-border">
          <form className="grid gap-6">
            ...
            <div>
              ...
              <textarea rows={5} className="w-full rounded-xl border border-border px-4 py-3 bg-background" placeholder="Décrivez votre besoin" />
            </div>
