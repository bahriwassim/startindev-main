      ...
      <div className="fixed top-0 w-full bg-white shadow-sm z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-16 text-sm">
            ...
            <a href="/entertainment" className="px-4 py-2 text-gray-600 hover:text-orange-600 transition-colors font-medium">Aperçu</a>
            <a href="/entertainment/creation" className="px-4 py-2 text-gray-600 hover:text-orange-600 transition-colors font-medium">Création</a>
            <a href="/entertainment/communication" className="px-4 py-2 text-orange-600 font-bold border-b-2 border-orange-600">Communication</a>
            <a href="/entertainment/digital" className="px-4 py-2 text-gray-600 hover:text-orange-600 transition-colors font-medium">Digital</a>
            <a href="/entertainment/contact" className="ml-auto px-6 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors font-medium">Contact</a>
          </div>
        </div>
      </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-orange-600 font-medium">Brand Strategy</p>
                </div>
              </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  ...
                  <p className="text-orange-600 font-medium">Performance Marketing</p>
                </div>
              </div>
      ...
      <section className="py-16 bg-orange-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/entertainment/contact" className="bg-white text-orange-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
              Lancer ma campagne
            </a>
