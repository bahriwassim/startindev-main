      ...
      <div className="fixed top-0 w-full bg-white/90 backdrop-blur-md border-b border-border/50 z-40 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center h-12 text-sm overflow-x-auto">
            ...
            <a href="/entertainment/digital" className="px-3 py-2 text-primary font-semibold">Digital</a>
          </div>
        </div>
      </div>
      <section className="hero-gradient pt-28 pb-16 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Solutions Digitales</h1>
          <p className="text-xl opacity-95 max-w-2xl">Mini-sites, landing pages événements, outils de gestion et suivi.</p>
        </div>
      </section>
      <section className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-8">
          <div className="bg-card rounded-2xl p-8 border border-border shadow-lg">
            <h3 className="text-xl font-bold mb-2">Mini-sites</h3>
            <p className="text-muted-foreground">Présentations, agenda, intervenants et infos pratiques.</p>
          </div>
          <div className="bg-card rounded-2xl p-8 border border-border shadow-lg">
            <h3 className="text-xl font-bold mb-2">Outils de gestion</h3>
            <p className="text-muted-foreground">Billetterie, check‑in QR, gestion invités.</p>
          </div>
          <div className="bg-card rounded-2xl p-8 border border-border shadow-lg">
            <h3 className="text-xl font-bold mb-2">Suivi & analytics</h3>
            <p className="text-muted-foreground">Tableaux de bord et rapports.</p>
          </div>
        </div>
      </section>
    </div>
