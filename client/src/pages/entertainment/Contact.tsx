  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="hero-gradient pt-28 pb-16 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Contact Événementiel</h1>
          <p className="text-xl opacity-95 max-w-2xl">Parlons de votre prochain événement.</p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 bg-card rounded-2xl p-8 shadow-lg border border-border">
          <form className="grid gap-6">
            ...
            <div>
              ...
              <textarea rows={5} className="w-full rounded-xl border border-border px-4 py-3 bg-background" placeholder="Type d’événement, date, lieu, audience..." />
            </div>
